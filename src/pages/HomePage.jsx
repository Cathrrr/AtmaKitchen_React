            ...
            <Container className="mt-5">
                <Row>
                    <Col md={7}>
                        ...
                        <p className="lead">
                            Diciptakan oleh <strong>Catherine Charissa Oktaviani</strong>, Mahasiswa Universitas Atma Jaya Yogyakarta dari program studi Informatika.
                        </p>
                        <p className="lead">
                            Nomor Pokok Mahasiswa: <strong>220711939</strong>.
                        </p>
                    </Col>
                    <Col md={5}>
