...
const FormLogin = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (user.username === "" || user.password === "") {
            ...
            return;
        } else if (user.password.length !== 5 || user.username !== "catherine") { // ganti dengan username dan password yang benar
    ...
    return (
        <form onSubmit={handleSubmit} style={{ maxWidth: "700px", margin: "auto" }}>
            ...
            <FloatingLabel controlId="floatingInput" label="Username" className="mb-3">
                <Form.Control type="text" placeholder="name@example.com" onChange={handleChange} name="username" />
            </FloatingLabel>
